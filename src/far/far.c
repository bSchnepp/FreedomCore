...
/*
 *	One of the problems we'll have to deal with is that an archive made on x86-64 will not extract on x86, normally.
...
{
	struct free_arc_file* parent;
	struct free_arc_file** children;
...
{
	//Create a folder with the same name as the archive save for the '.far', or '.frdmar' extension.
	...
	for (int i = 0; i < size_of_string; i++)
	{
		...
		//std library can do this, what am I doing.
